...
export const createUserGuest = async (data) => {
  try {
    ...
    console.error(
      ">>>> userGuestService.js:  Error creating user guest:",
      error,
    );
    throw error;
  }
...
export const userGuestExists = async (email) => {
  try {
    ...
    console.error(
      ">>>> userGuestService.js:  Error checking if user guest exists:",
      error,
    );
    throw error;
  }
...
export const userGuestResponseService = async (
  userGuestId,
  userGuestStatus,
) => {
  try {
    ...
    console.error(
      ">>>> userGuestService.js: Error updating user guest:",
      error,
    );
    throw error;
  }
...
export const getUserGuests = async () => {
  try {
    ...
    console.error(
      ">>>> userGuestService.js: Error getting user guests:",
      error,
    );
    throw error;
  }
...
export const getUserGuestByBusinessIdService = async (businessId) => {
  try {
    ...
    console.error(
      ">>>> userGuestService.js: Error getting user guest by business id:",
      error,
    );
    throw error;
  }
