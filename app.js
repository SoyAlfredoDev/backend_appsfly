...
import opticsWorkOrdersRoutes from "./routes/opticsWorkOrders.routes.js";
import purchaseCertificatesRoutes from "./routes/purchaseCertificates.routes.js";
...
app.use("/api", opticsWorkOrdersRoutes);
app.use("/api", purchaseCertificatesRoutes);
